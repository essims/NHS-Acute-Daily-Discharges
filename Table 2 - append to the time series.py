# -*- coding: utf-8 -*-
"""
Created on Tue Oct 24 11:16:05 2023
...
df = pd.read_excel(r"C:\Users\Esra Simsek\Desktop\ADD-tall versions\September-2023\Daily-discharge-sitrep-monthly-data-webfile-September2023.xlsx", sheet_name='Table 2')
...
existing_file_path="C:\\Users\\Esra Simsek\\Desktop\\ADD-tall versions\\Ex-Time Series-ADD-Table2.csv"

df.to_csv(existing_file_path, mode='a', header=False, index=False)
